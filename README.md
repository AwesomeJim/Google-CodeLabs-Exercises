...
- [ ] Choose a [LICENSE](https://github.com/AwesomeJim/Google-CodeLabs-Exercises/community/license/new?branch=master).
- [ ] Set your `ORG_GRADLE_PROJECT_NEXUS_USERNAME`, `ORG_GRADLE_PROJECT_NEXUS_PASSWORD`, `ORG_GRADLE_PROJECT_SIGNING_KEY` and `ORG_GRADLE_PROJECT_SIGNING_PWD` secrets in [Settings](https://github.com/AwesomeJim/Google-CodeLabs-Exercises/settings/secrets/actions).

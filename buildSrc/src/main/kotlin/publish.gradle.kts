        ...
        publications {
            create<MavenPublication>("release") {
                ...
                pom {
                    ...
                    url.set("https://github.com/awesomejim/googlecodelabsexercises/")
                    ...
                    scm {
                        connection.set("scm:git:git://github.com/awesomejim/googlecodelabsexercises.git")
                        developerConnection.set("scm:git:ssh://github.com/awesomejim/googlecodelabsexercises.git")
                        url.set("https://github.com/awesomejim/googlecodelabsexercises/")
                    }
                    issueManagement {
                        system.set("GitHub Issues")
                        url.set("https://github.com/awesomejim/googlecodelabsexercises/issues")
                    }
                }
            }
        }
